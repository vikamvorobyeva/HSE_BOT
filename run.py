...
if __name__ == "__main__":
    ...
    choose = st.selectbox("Graphics: ", ['interrelation (Difference to Price In %) and (Difference to Cup In %)  without Form Juice', 'describe',11111 ' Comparison with one edible cup of food','Comparison Cup equivalent price with its size' ' interrelation (Difference to Price In %) and (Difference to Cup In %)  without Form Juice',' Graphic Fresh',' Graphic Canned',  ' Graphic Juice',  ' Graphic Dried',' Graphic Frozen', ])
